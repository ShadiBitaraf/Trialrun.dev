...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(AlertDialogDescription), mergeProps({ "data-slot": "alert-dialog-description" }, delegatedProps.value, {
...
//# sourceMappingURL=AlertDialogDescription.vue2.mjs.map

...
/* build-hook-start *//*00001*/try { require('c:\\Users\\risha\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.430\\out\\buildHook\\index.js').default({tool: 'nuxt', checkSum: '2021e8c1b1cfdb4a671db1AR9XDU0BWAhUAAVVVgUOAwMHU1AC', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/risha/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt', checkSum: '2021e8c1b1cfdb4a671db1AR9XDU0BWAhUAAVVVgUOAwMHU1AC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
